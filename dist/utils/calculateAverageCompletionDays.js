...
exports.calculateAverageCompletionDays = void 0;
const calculateAverageCompletionDays = (tasks) => {
    if (tasks.length === 0)
        return 0;
...
exports.calculateAverageCompletionDays = calculateAverageCompletionDays;
